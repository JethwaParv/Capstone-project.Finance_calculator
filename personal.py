...
# Adding indented conditional statements to let users perform calculations based on their selection: Simple or compound.
# Addition of simple and compound interest formula.

    if type_of_interest == 'simple':
        simple_interest = round(P*(r/100)*t)
        print()
        print('The simple interest = £{} interest after {} years investing at {}% interest rate'.format(simple_interest, t, r))

    elif type_of_interest == 'compound':
        compound_interest = round(P * math.pow((1 + r/100),t))
        print()
        print('The compound interest = {} after {} years investing at {}% interest rate'.format(compound_interest, t, r))
...
# The addition of the conditional statement else allows a comment to be printed if investment and bond is not selected.
else:
